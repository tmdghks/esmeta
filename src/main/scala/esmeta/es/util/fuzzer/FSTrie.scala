...
import esmeta.util.BaseUtils.computeChiSq
...
case class FSTrieConfig(
  promotionCriteria: Double = 3, // 3 sigma for promotion by default
  demotionCriteria: Double = 3, // 3 sigma for demotion by default
